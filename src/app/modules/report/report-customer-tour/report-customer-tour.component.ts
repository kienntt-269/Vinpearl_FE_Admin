...
@Component({
  selector: 'app-report-customer-tour',
  templateUrl: './report-customer-tour.component.html',
  styleUrls: ['./report-customer-tour.component.scss']
})
export class ReportCustomerTourComponent implements OnInit {
  ...
  exportFile() {
    ...
    this.bookingService.exportFileTour(data).subscribe(res => {
